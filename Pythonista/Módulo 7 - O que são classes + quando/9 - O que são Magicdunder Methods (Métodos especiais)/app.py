documentacaoPyhton = 'https://docs.python.org/pt-br/3/reference/datamodel.html#specialnames'

# Métodos Magicos(Magic Methods, dunder methods(double underscore))
...
class Pessoa:
    ...
    # Representação para programadores (chamando com método repr(pessoa))
    def __repr__(self):
